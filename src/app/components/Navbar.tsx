...
export default function Navbar() {
    ...
    useEffect(() => {
        ...
        // Rilevamento touch più affidabile (include iPad, iPhone, Android)
        const touchCheck =
        ...
        <nav ref={navRef} className="relative flex items-center justify-between px-6 py-3 bg-color text-color">
            ...
            >
                ...
                <li className="relative group">
                    ...
                    <ul
                        className={`absolute left-0 rounded shadow-md min-w-[140px] p-2 z-50 bg-color transition-opacity duration-200
                        ${dropdownOpen.list ? 'block' : isTouchDevice ? 'hidden' : 'lg:block lg:opacity-0 lg:group-hover:opacity-100 lg:pointer-events-auto'}`}
                    >
                        <li>
                ...
                <li className="relative group">
                    ...
                    <ul
                        className={`absolute left-0 rounded shadow-md min-w-[140px] p-2 z-50 bg-color transition-opacity duration-200
                        ${dropdownOpen.account ? 'block' : isTouchDevice ? 'hidden' : 'lg:block lg:opacity-0 lg:group-hover:opacity-100 lg:pointer-events-auto'}`}
                    >
                        <li>
